...
class CleaningTransformer:
    ...
    def clean_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_cleaned['age'] = ((current_date - df_cleaned['dob']).dt.days/365.25).astype(int)
        ...
        df_cleaned['amount_abs'] = np.abs(df_cleaned['amount'])
        ...
        df_cleaned.drop(columns=['name', 'description', 'currency'], inplace=True)
